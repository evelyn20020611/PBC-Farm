...
class Farm(tk.Frame):  # try
    ...
    def click_button_book(self):
        ...
        easy_or_not11 = tk.Label(illustrated_book, text='★', height=2, width=15, font=('TkDefaultFont', 20), fg='yellow')
        ...
        easy_or_not22 = tk.Label(illustrated_book, text='★★★', height=2, width=15, font=('TkDefaultFont', 20), fg='yellow')
        ...
        easy_or_not33 = tk.Label(illustrated_book, text='★★★★★', height=2, width=15, font=('TkDefaultFont', 20), fg='yellow')
