...
class Farm(tk.Frame):  # try
    ...
    def open_store(self): # 點了種子商店按鈕後的function
        ...
        lab1 = tk.Label(r1, text='青椒種子', height=2, width=25, bg='white', fg='black')
        lab1.grid(row=7, column=1, padx = 90, ipadx = 10, ipady = 10)
        lab2 = tk.Label(r1, text='茄子種子', height=2, width=25, bg='white', fg='black')
        lab2.grid(row=7, column=3, padx = 90, ipadx = 10, ipady = 10)
        lab3 = tk.Label(r1, text='香菜種子', height=2, width=25, bg='white', fg='black')
