...
class Farm(tk.Frame):  # try
    ...
    def open_store(self): # 點了種子商店按鈕後的function
        ...
        # grid 上去
        #sticky = tk.N+tk.S
        self.button_seed_package_pepper.grid(row = 1, column = 1)
        self.button_seed_package_eggplant.grid(row = 1, column = 2)
        self.button_seed_package_coriander.grid(row = 1, column = 3)
